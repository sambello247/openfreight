        ...
        <div class="container-xl">
          ...
          <div class="row">
            <div class="col-md-8 mb-3">
                All shippers information provided below.
            </div>
          ...
          @if ($shippers->count()==0)
          <div class="col-md-12"><h3>Sorry! No record found for Origination.</h3></div>
          @else
          <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    @foreach ($shippers as $shipper)
                      <tr>
                        <td class="sort-name">{{$shipper->fullname}}</td>
                        <td class="sort-company">{{$shipper->company_name}}</td>
                        <td class="sort-department">{{$shipper->department}}</td>
                        <td class="sort-phone">{{$shipper->phone}}</td>
                        <td class="sort-fax">{{$shipper->fax}}</td>
                        <td class="sort-email">{{$shipper->email}}</td>
                        <td class="sort-address">{{$shipper->address_line_1}}</td>
                        <td class="sort-address">{{$shipper->address_line_2}}</td>
                        <td class="sort-city">{{$shipper->city}}</td>
                        <td class="sort-state">{{$shipper->state}}</td>
                        <td class="sort-postal">{{$shipper->postal}}</td>
                        <td class="sort-country">{{$shipper->country}}</td>
                      </tr>
                    @endforeach
                    </tbody>
                  </table>
          ...
          <div class="mt-3">{{ $shippers->links() }}</div>
          @endif
