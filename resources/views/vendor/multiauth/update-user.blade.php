                ...
                <div class="col-xl-7">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control" name="first-name" value="{{$user->first_name}}" placeholder="First Name">
                        </div>
              
                        <div class="col-lg-6">
                          <label class="form-label">Last Name</label>
                          <input type="text" class="form-control" name="last-name" value="{{$user->last_name}}" placeholder="Last Name">
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-3">
                          ...
                          <select class="form-select" name="account-type" aria-label="Default select example">
                            <option selected disabled>{{$user->account_type}}</option>
                        ...
                        <div class="col-lg-3">
                          ...
                          <select class="form-select" name="account-status" aria-label="Default select example">
                            <option selected disabled>{{$user->account_status}}</option>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control" name="business-name" value="{{$user->profile->business_name}}" placeholder="Business Name">
                        </div>
                        
              
                        <div class="col-lg-6">
                          <label class="form-label">Address</label>
                          <input type="text" class="form-control" name="address" value="{{$user->profile->address}}" placeholder="Address">
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="text" class="form-control" name="state" value="{{$user->profile->state}}" placeholder="State">
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-6">
                          ...
                          <input type="phone" class="form-control" name="phone" value="{{$user->profile->phone}}" placeholder="Phone Number">
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-3">
                          ...
                          <input type="text" class="form-control" name="postal" value="{{$user->profile->postal}}"  placeholder=" Postal Code">
                        </div>
              
                        <div class="col-lg-3">
                          <label class="form-label">DOB</label>
                          <input type="date" class="form-control" value="{{$user->profile->DOB}}" name="dob">
                        </div>
              
                        <div class="col-lg-6">
                          <label class="form-label">Website</label>
                          <input type="text" class="form-control" name="website" value="{{$user->profile->website}}" placeholder="Website">
                        </div>
                    ...
                    <button type="submit" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg>Update User</button>
                    </div>
