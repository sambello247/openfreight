            ...
            <header class="navbar navbar-expand-md navbar-light sticky-top d-print-none">
              <div class="container-xl">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                  <a href=".">
                    <img src="/img/of.png" width="110" height="32" alt="Tabler" class="navbar-brand-image">
                  </a>
                </h1>
                <div class="navbar-nav flex-row order-md-last">
                  ...
                  <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                      ...
                      <a href="/admin/password/change" class="dropdown-item">Change password</a>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <div class="dropdown-menu">
                          <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
							  ...
							  <a class="dropdown-item" href="/admin/warehouse">
                                Warehouse
                              </a>
					  ...
					  <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                          <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
							  <a class="dropdown-item" href="/admin/shippers">
                                Origination
                              </a>
							  <a class="dropdown-item" href="/admin/receivers">
                                Destination
                              </a>
                              <a class="dropdown-item" href="/admin/shipping">
                                Shipping Transaction
                              </a>
                              <a class="dropdown-item" href="/admin/track">
                                Track & Trace
                              </a>
                          </div>
                        </div>
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <a class="dropdown-item" href="{{ route('admin.roles') }}" rel="noopener">
                            Role
                          </a>
